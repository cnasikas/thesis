...
\section{Consensus defined types of Blockchain}\label{bltech:consensus_blockchain_types}
...
\subsection{Hyperledger}\label{bltech:impl:hyperledger}
...
\subsection{Enigma}\label{bltech:impl:enigma}
