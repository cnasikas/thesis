...
The security of the protocol is based on the difficulty of the discrete log problem (DLOG). A passive adversary cannot compute the secret key $k$ because she does not know $x_a$ or $x_b$. To find them she have to solve the DLOG problem which is assumed to be hard.
