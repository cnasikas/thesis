...
\tikzset{%
    ...
    table/.style={%
      matrix of nodes, nodes in empty cells, column sep=-0.5, row sep=-0.5, nodes={draw,anchor=center,minimum width=2cm,minimum height=0.7cm, font=\footnotesize}
    }
}
...
\newcommand{\eparn}[1]{\paragraph*{#1}\mbox{}\\}
